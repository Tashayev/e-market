...
export const extraReducers = (builder: ActionReducerMapBuilder<ProductState>) => {
  ...
  builder.addMatcher(
    isAnyOf(getCategoryById.fulfilled),
    (state, action) => {
      state.categories = action.payload;
    }
  );
  ...
  builder.addMatcher(
    isAnyOf(getProductById.fulfilled),
    (state, action) => {
  ...
  builder.addMatcher(
    isAnyOf(createCategory.fulfilled),
    (state, action) => {
  ...
  builder.addMatcher(
    isAnyOf(updateCategory.fulfilled),
    (state, action) => {
  ...
  builder.addMatcher(
    isAnyOf(deleteCategory.fulfilled),
    (state, action) => {
  ...
  builder.addMatcher(
    isAnyOf(deleteProduct.fulfilled),
    (state, action) => {
      const id = action.payload;
  ...
  builder.addMatcher(
    isAnyOf(updateProduct.fulfilled),
    (state, action) => {
  ...
  builder.addMatcher(
    isAnyOf(createProduct.fulfilled),
    (state, action) => {
